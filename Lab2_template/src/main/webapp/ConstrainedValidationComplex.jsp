...
<meta charset="UTF-8">
<title> Form </title>
<style>             #constraint validation API to 
input:valid {
...
<form novalidate action="RegisterController">
  ...
  <input type="text" id="name" name="user" placeholder="Name" value="${model.name}" required><br>
  <label for="user"> Surname:</label><br>
  <input type="text" id="surname" name="user" placeholder="Username" value="${model.surname}" required><br>
  ...
  <select name="degrees" id="degree">
	 <option value="${model.degree}">info</option>
	 <option value="${model.degree}">dades</option>
  </select>
